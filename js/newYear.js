...
var newYear = () => {
    ...
    // 新年时间戳 and 星期对象
    let newYear = new Date('2026-02-11 00:00:00').getTime() / 1000,
    ...
    jQuery(document).ready(function ($) {
        $('#newYear').wpSuperSnow({
            flakes: ['https://tuchuang.voooe.cn/images/2023/01/02/yb1.webp', 'https://tuchuang.voooe.cn/images/2026/02/11/yb2.webp', 'https://tuchuang.voooe.cn/images/2026/02/11/yb3.webp'],
            totalFlakes: '100',
            zIndex: '999999',
            maxSize: '30',
            maxDuration: '20',
